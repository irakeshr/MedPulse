import CountUp from "../../../reactBitAnimation/CountUp"; // Ensure this path is correct
const ProfileStats = ({ stats }) =>{
  ...
  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
    <div className="bg-white dark:bg-[#1a2c2c] p-4 rounded-2xl border border-[#e5e7eb] dark:border-[#2a3838] flex items-center gap-4 shadow-sm">
      ...
      <div>
        <div className="text-2xl font-bold text-med-dark dark:text-white">
          <CountUp to={stats?.postCount || 0} duration={2} className="count-up-text" />
        </div>
    ...
    <div className="bg-white dark:bg-[#1a2c2c] p-4 rounded-2xl border border-[#e5e7eb] dark:border-[#2a3838] flex items-center gap-4 shadow-sm">
      ...
      <div>
        <div className="text-2xl font-bold text-med-dark dark:text-white">
          <CountUp to={stats?.helpfulPostCount|| 0} duration={2} className="count-up-text" />
        </div>
    ...
    <div className="bg-white dark:bg-[#1a2c2c] p-4 rounded-2xl border border-[#e5e7eb] dark:border-[#2a3838] flex items-center gap-4 shadow-sm">
      ...
      <div>
        <div className="text-2xl font-bold text-med-dark dark:text-white">
          <CountUp to={stats?.commentCount || 0} duration={2} className="count-up-text" />
        </div>
