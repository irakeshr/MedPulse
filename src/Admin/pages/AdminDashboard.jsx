          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 ">
            <div>
              ...
              <p className="text-med-text-secondary dark:text-gray-400 text-sm mt-1">
                Welcome back, here's what's happening on MedPulse today.
              </p>
            </div>
          ...
          <div className="grid grid-cols-1 xl:grid-cols-3 gap-8 items-start">
            ...
            <div className="xl:col-span-2 mb-5 bg-white dark:bg-[#1a2c2c] rounded-2xl border border-[#e5e7eb] dark:border-[#2a3838] shadow-sm flex flex-col">
              <div className="p-5 border-b border-[#e5e7eb] dark:border-[#2a3838] flex justify-between items-center">
                ...
                <a
                  className="text-xs font-bold text-primary hover:text-primary-dark uppercase tracking-wide"
                  href="#"
                >
                  View All
                </a>
                ...
                <table className="w-full text-left text-sm">
                  ...
                  <tbody className="divide-y divide-[#e5e7eb] dark:divide-[#2a3838]">
                    ...
                    {doctorProfile?.map((value, index) => {
                      return value.licenseNumber !== "N/A" ? (
                        <tr
                          key={index}
                        ...
                        >
                          ...
                          <td className="px-6 py-4 font-mono text-xs text-med-text-secondary">
                            {value.licenseNumber}
                          </td>
                          <td className="px-6 py-4 text-med-text-secondary">
                            {" "}
                            {value.updatedAt &&
                            isValid(new Date(value.updatedAt))
              ...
              <div className="p-0 overflow-y-auto custom-scrollbar">
                ...
                <div className="p-4 border-b border-[#e5e7eb] dark:border-[#2a3838] hover:bg-med-gray/20 transition-colors">
                  <div className="flex justify-between items-start mb-2">
                    <span className="inline-flex items-center px-2 py-0.5 rounded text-[10px] font-bold bg-red-100 text-red-700 dark:bg-red-900/30 dark:text-red-300">
                      Harassment
                    </span>
                  ...
                  <p className="text-sm text-med-dark dark:text-gray-300 font-medium mb-1">
                    "You clearly don't know what..."
                  </p>
                  <p className="text-xs text-med-text-secondary mb-3">
                    Reported by: User_992
                  </p>
                  <div className="flex gap-2">
                    <button className="flex-1 px-3 py-1.5 bg-med-dark dark:bg-white text-white dark:text-med-dark text-xs font-bold rounded-lg hover:bg-opacity-90">
                      Review
                    </button>
                    <button className="px-3 py-1.5 border border-[#e5e7eb] dark:border-[#2a3838] text-med-text-secondary text-xs font-bold rounded-lg hover:bg-med-gray dark:hover:bg-[#253636]">
                      Dismiss
                    </button>
                  </div>
                </div>
                ...
                <div className="p-4 border-b border-[#e5e7eb] dark:border-[#2a3838] hover:bg-med-gray/20 transition-colors">
                  <div className="flex justify-between items-start mb-2">
                    <span className="inline-flex items-center px-2 py-0.5 rounded text-[10px] font-bold bg-orange-100 text-orange-700 dark:bg-orange-900/30 dark:text-orange-300">
                      Misinformation
                    </span>
                    <span className="text-xs text-med-text-secondary">
                      45m ago
                  ...
                  <p className="text-sm text-med-dark dark:text-gray-300 font-medium mb-1">
                    "Drink this herbal tea to cure..."
                  </p>
                  <p className="text-xs text-med-text-secondary mb-3">
                    Reported by: Dr. Emily Chen
                  </p>
                  <div className="flex gap-2">
                    <button className="flex-1 px-3 py-1.5 bg-med-dark dark:bg-white text-white dark:text-med-dark text-xs font-bold rounded-lg hover:bg-opacity-90">
                      Review
                ...
                <div className="p-4 hover:bg-med-gray/20 transition-colors">
                  ...
                  <p className="text-sm text-med-dark dark:text-gray-300 font-medium mb-1">
                    "Buy cheap meds now at..."
                  </p>
                  <p className="text-xs text-med-text-secondary mb-3">
                    Reported by: System Bot
                  </p>
                  <div className="flex gap-2">
                    <button className="flex-1 px-3 py-1.5 bg-med-dark dark:bg-white text-white dark:text-med-dark text-xs font-bold rounded-lg hover:bg-opacity-90">
                      Review
          ...
          <div className="bg-white dark:bg-[#1a2c2c] rounded-2xl border border-[#e5e7eb] dark:border-[#2a3838] shadow-sm p-6 mb-8">
            <div className="flex justify-between items-center mb-6">
              <div>
                ...
                <p className="text-xs text-med-text-secondary mt-1">
                  Manage featured tags and monitor rising health trends.
                </p>
              </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
              <div className="flex items-center justify-between p-3 rounded-xl border border-primary/30 bg-primary/5">
                <span className="font-medium text-med-dark dark:text-white text-sm">
                  #Migraine
                </span>
                <div className="flex items-center gap-2">
                  ...
                  <button className="text-med-text-secondary hover:text-red-500">
