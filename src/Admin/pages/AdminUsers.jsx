          ...
          <div className="bg-white dark:bg-[#1a2c2c] rounded-2xl border border-[#e5e7eb] dark:border-[#2a3838] shadow-sm flex flex-col overflow-hidden">
              ...
              <table className="w-full text-left text-sm">
                ...
                <tbody className="divide-y divide-[#e5e7eb] dark:divide-[#2a3838]">
                  {allUsers?.map((user) => (
                    <tr
                      key={user._id}
                      className={`hover:bg-med-gray/30 dark:hover:bg-[#253636]/50 transition-colors ${user.status === "Suspended" ? "bg-red-50/30 dark:bg-red-900/5" : ""}`}
                    >
                      ...
                      <td className="px-6 py-4">
                        <span
                          className={`inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full text-xs font-medium ${getStatusStyle(user.stats.approved).badge}`}
                        >
                          <span
                            className={`size-1.5 rounded-full ${getStatusStyle(user.stats.approved).dot}`}
                          ></span>
                          {user.stats.approved}
                        </span>
                      </td>
            ...
            <div className="px-6 py-4 border-t border-[#e5e7eb] dark:border-[#2a3838] flex items-center justify-between bg-white dark:bg-[#1a2c2c]">
              ...
              <div className="flex items-center gap-2">
                <button
                  className="p-2 rounded-lg border border-[#e5e7eb] dark:border-[#2a3838] text-med-text-secondary hover:bg-med-gray dark:hover:bg-[#253636] disabled:opacity-50"
                  disabled
                >
                  <span className="material-symbols-outlined text-[20px]">
                    chevron_left
                ...
                <button className="px-3 py-1 rounded-lg bg-med-dark dark:bg-primary text-white dark:text-med-dark text-sm font-medium">
                  1
                </button>
                <button className="px-3 py-1 rounded-lg text-med-text-secondary hover:bg-med-gray dark:hover:bg-[#253636] text-sm font-medium">
                  2
                </button>
                <button className="px-3 py-1 rounded-lg text-med-text-secondary hover:bg-med-gray dark:hover:bg-[#253636] text-sm font-medium">
                  3
